...
public class OSInfoDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TextView colt_version = content.findViewById(R.id.dev_info_colt_version);
        ...
        colt_version.setText(SystemProperties.get("ro.modversion"));
        ...
        LinearLayout colt_version_layout = content.findViewById(R.id.colt_version_layout);
        LinearLayout android_version_layout = content.findViewById(R.id.android_version_layout);
        colt_version_layout.setOnClickListener(new View.OnClickListener() {
            @Override
   ...
   public void updateVisibilities(View view) {
        ...
        LinearLayout colt_version_layout = view.findViewById(R.id.colt_version_layout);
        ...
        if (SystemProperties.get("ro.modversion").isEmpty()) {
            colt_version_layout.setVisibility(View.GONE);
        }
